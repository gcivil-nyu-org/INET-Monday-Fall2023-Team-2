...
from socialuser.models import SocialUser, PRONOUN_CHOICES
...
#     date_of_birth = forms.DateField(widget=forms.SelectDateWidget(years=range(1920, date.today().year - 18)), required=True)
#     email = forms.EmailField(required=True)
...
#     major = forms.CharField(max_length=100, required=True)
    ...
    def validate_password(password1, password2):
        if len(password1) < 8:
            ...
            raise ValidationError('Password cannot be all letters.')
